  ...
  return (
    <View style={{ flex: 1 }}>
      ...
      <View style={{ alignItems: "center", padding: 20 }}>
        ...
        />
        <Text style={{ fontSize: 24, fontWeight: "bold", marginVertical: 10, color: 'black' }}>{user.name}</Text>
      ...
      <View style={{ flexDirection: "row", justifyContent: "center", marginVertical: 2 }}>
        <TouchableOpacity
          ...
          style={{ backgroundColor: "#6146C6", borderRadius: 14, width: 110, marginRight: 13, alignItems: "center", padding: 10, height:70, }}
        >
          <Text style={{ color: 'white',marginTop:10, }}>3 Ongoing Task</Text>
        </TouchableOpacity>
        <TouchableOpacity
          onPress={() => handleOptionPress('Settings')}
          style={{ backgroundColor: "#6146C6", borderRadius: 14, width: 110, marginLeft: -1, alignItems: "center", padding: 10, height:70, }}
        >
